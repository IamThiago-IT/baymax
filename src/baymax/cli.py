...
_AFFIRMATIVE_KEYWORDS: dict[str, tuple[str, ...]] = {
    "eng": (
        "yes", "yeah", "yep", "yup", "fine", "okay", "ok",
        "good", "great", "alright", "well", "better",
        "i'm fine", "i'm ok", "i'm okay", "i'm well",
        "i am fine", "i am ok", "feeling good", "feeling better",
    ),
    "ptbr": (
        "sim", "tudo bem", "tudo bom", "estou bem", "me sinto bem",
        "ok", "ok", "ótimo", "ótima", "bom", "bem", "melhor",
        "estou ótimo", "estou ótima", "tô bem", "me sinto ótimo",
    ),
}
